...
<div class="container">
    ...
    <form action="ccatagry_profile_movie_add_b.php" method="post">
...
<option for value="from">catagry Name</option>
              <?php 
         foreach ($m_c_options as $c_name_option) {
         echo "<option value = '".$c_name_option['m_catagry']."'>" .$c_name_option['m_catagry']."</option>";            
             }
...
<option for value="from">Movie id..</option>
         ...
         echo "<option value = '".$m_name_option['m_id']."'>" .$m_name_option['m_id']." -".$m_name_option['m_name'].""."</option>";            
             }
