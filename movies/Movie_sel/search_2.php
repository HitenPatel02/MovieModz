...
<html lang="en">
  ...
  position: relative;
    ...
    <div class="action-header">
            <h2 class="action"><?php echo $search_movie;?></h2>
        </div>
        <div class="container">
        ...
        <?php
            ...
            $search_movie_sql = "SELECT * FROM `movies` WHERE `m_name` LIKE '%$search_movie%'";
            
           $search_movie_res = $conn->query($search_movie_sql);
                           $search_movie_data= array();
                           while ($search_movie_row = mysqli_fetch_assoc($search_movie_res)) {
                               $search_movie_data[] = $search_movie_row;
                           }

foreach ($search_movie_data as $search_movie_data_row):
   
   
    echo '<div class="card">';
    echo "<form method='post'>";
    echo '<a href="movie_sel_2.php">';  
    echo "<button formaction='movie_sel_2.php'>";
    
        echo '<img class="card-image" src="../'.$search_movie_data_row['m_p_url'] . ' ">';
        echo '</a>';
        echo '<div class="card-container">';
        echo '<h4><b>'.$search_movie_data_row['m_name'].'</b></h4>';
        echo "<input type='hidden' name='c_name' value='".$search_movie_data_row['m_name'] ."'>";
