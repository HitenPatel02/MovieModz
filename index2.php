...
<?php
    if ($slides_result->num_rows > 0) {
        ...
        while($slides_row = $slides_result->fetch_assoc()) {
            ...
            // echo "<a>";
            echo '<a href="movies/Movie_sel/movie_sel_2.php">';
            echo "<button class='transparent-button'  formaction ='movies/Movie_sel/movie_sel_2.php'  style='width:100%';>"; 
            ...
            <div class="new-release-content">
               ...
               if ($new_result->num_rows > 0) {
                ...
                while($new_row = $new_result->fetch_assoc()) {
                    ...
                    echo '<a href="movies/Movie_sel/movie_sel_2.php">';
                    echo "<form method='post'>";
                    echo "<button  formaction ='movies/Movie_sel/movie_sel_2.php' style='background-color: transparent'>";
...
?>
            ...
            <?php
               if ($Upcoming_result ->num_rows > 0) {
                ...
                while($Upcoming_row = $Upcoming_result->fetch_assoc()) {
                    ...
                    echo '<a href="movies/Movie_sel/movie_sel_2.php">';
                    echo "<form method='post'>";
                    echo "<button style='background-color: transparent' formaction ='movies/Movie_sel/movie_sel_2.php' >";
                    // echo '<img class="nrimg" src="movies/new-release1.webp" alt="1" class="release-img">';
                    // echo '<img class="nrimg" src="movies/new-release1.webp" alt="1" class="release-img">';
        ...
        <div>
            ...
            <?php 
                ...
                echo "<form method='post'>";
                echo "<button class='act'  formaction ='movies\Movie_sel\movie_genres_2.php' style='background-color: transparent'>";
                echo '<a href= "movies\Movie_sel\movie_genres_2.php"';
            ...
            ?>
                <a href="pages/categories/romance/romance.html"><div class="genre-items"><p>Romance</p></div></a>
...
?>
        ...
        <div>
            ...
            echo "<button class='act' formaction ='pages/actors/actor_profile/actor_profile_2.php' style='background-color: transparent'>";
        ...
        <div>
            ...
            <?php
                ...
                echo "<form method='post'>";
                echo "<div class='actors-img'>";
                echo "<button class='act' formaction ='pages/actors/actor_profile/actor_profile.php' style='background-color: transparent'>";
